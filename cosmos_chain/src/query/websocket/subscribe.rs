...
use log::trace;
use tendermint_rpc::{event::Event, query::{EventType, Query}, Subscription, SubscriptionClient, WebSocketClient, WebSocketClientUrl};
...
impl EventSubscriptions {
    pub fn new(rt: Arc<Runtime>) -> EventSubscriptions {    
        ...
        EventSubscriptions { client, subs, driver_handle, queries, rt }   
    }
