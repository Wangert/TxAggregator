...
pub mod merkle_proof_tests {
    ...
    pub fn do_next_hash_works() {
        ...
        let mut child = vec![
            232, 62, 42, 175, 213, 61, 52, 244, 124, 248, 43, 44, 34, 153, 124, 250, 66, 112, 6, 80, 225, 152, 135, 150, 75, 76, 140, 187, 28, 99, 229, 132
        ];
        let mut suffix = vec![
            201, 202, 163, 167, 203, 138, 111, 43, 237, 184, 17, 177, 240, 169, 251, 246, 117, 160, 227, 80, 194, 21, 101, 37, 98, 253, 53, 56, 240, 87, 17, 160
        ];
        data.append(&mut child);
        ...
        let k: Vec<u8> = vec![99, 111, 109, 109, 105, 116, 109, 101, 110, 116, 115, 47, 112, 111, 114, 116, 115, 47, 98, 108, 111, 103, 47, 99, 104, 97, 110, 110, 101, 108, 115, 47, 99, 104, 97, 110, 110, 101, 108, 45, 52, 47, 115, 101, 113, 117, 101, 110, 99, 101, 115, 47, 49];
        let k_str: String = String::from_utf8_lossy(&k).to_string();
        println!("key:{:?}", k_str);
    }
